...
import { TooltipProvider } from "../_components/tooltip-provider";
          ...
          <div className="container ">
            <div className="haderbar__top d-flex align-items-left  justify-content-between ">
              <div className="logo__left d-flex align-items-center me-4">
                ...
                <Link href="/how-work" className="pra mdnone inter fw-40 mx-100 my-30 col-sm-2">
                  How It Works
                </Link>
                <Link href="/about" className="pra mdnone inter fw-40 mx-100 my-30">
                  Why AIHire
                </Link>
              </div> 
              <Separator/> 
